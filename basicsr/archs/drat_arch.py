...
from .arch_util import Upsample
...
encoder_aux.load_state_dict(torch.load("/data/cs/BlindSR/checkpoints/Encoder/aux/encoder_aux.pt")) # aux-encoder
encoder_blur.load_state_dict(torch.load("/data/cs/BlindSR/checkpoints/Encoder/blur/encoder_x4.pt")) # blur encoder
